          ...
          <div className="grid md:grid-cols-2 items-center gap-8">
            ...
            <div className="space-y-8">
              ...
              <p className="font-poppins text-[18px] sm:text-[20px] lg:text-[24px] text-[#252525] font-normal leading-relaxed max-w-md">
                Earn money with these simple steps, all you have to do is sign
                up and do simple tasks.
              </p>
              <button className="font-poppins text-[18px] sm:text-[20px] lg:text-[24px] font-semibold bg-[#2196F3] hover:bg-[#1976D2] text-white px-6 py-3 rounded-lg transition">
                Start Earning Now
              </button>
            </div>
